  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="./image/122.jpg" alt="Chania" width="932" height="522">
      </div>

      <div class="item">
        <img src="./image/123.jpg" alt="Chania" width="932" height="522">
      </div>
    
      <div class="item">
        <img src="./image/124.jpg" alt="Flower" width="932" height="522">
      </div>

      <div class="item">
        <img src="./image/125.jpg" alt="Flower" width="932" height="522">
      </div>
    </div>
