...
<%
	...
	String myurl = request.getRequestURI().toString();//url=http://localhost:8888/ShppingLab/main.jsp
	String uri = request.getRequestURI();//uri=/ShppingLab/main.jsp
	int idx = myurl.indexOf(uri);

	//웹 서버의 이미지를 올릴 경로
	String uploadPath = "/upload/";
	String uploadedFolder = myurl.substring(0, idx) + contextPath + uploadPath;//uploadedFolder=http://localhost:8888/ShoppingLab/upload
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<%=MyCtrlCommand%>boDetailView">상세 보기</a></li>
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<%=MyCtrlCommand%>prList">상세 보기</a></li>
						</ul></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
				...
				<ul class="nav navbar-nav navbar-right">
					<li><c:if test="${empty sessionScope.loginfo}">
							...
							<a href="<%=MyCtrlCommand%>meLogout">
							<span class="glyphicon glyphicon-log-in"> 로그 아웃 </span>
							</a>
						</c:if></li>
				</ul>
			</div>
